...
public class GameStateManager {
    ...
    private void init(){
        ...
        byte[] clientInfo = (B2DVars.MY_ID + ":CONNECT:0:0:" + B2DVars.CAM_WIDTH/2/B2DVars.PPM+":"+B2DVars.CAM_HEIGHT/2/B2DVars.PPM+":"+B2DVars.BIT_OPPONENT+":"+B2DVars.ID_OPPONENT+":red").getBytes();
