...
public class B2DVars {
    ...
    public final static int AMOUNT_BULLET = 3, AMOUNT_GRENADE = 10;
    ...
    // collision bits
    public static final short BIT_GROUND = 2, BIT_PLAYER = 4, BIT_OPPONENT = 8, BIT_BULLET = 16, BIT_GRENADE = 32, BIT_DOME = 64;
