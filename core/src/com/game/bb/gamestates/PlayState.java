...
public class PlayState extends GameState {
    ...
    private void grenadeBounces(float dt) {
        ...
        for (String s : grenades.keys()){ // this generates a concurrentModificationException
    ...
    public void update(float dt) {
        ...
        grenadeBounces(dt);
        //removeDeadBodies should always be last in update (but still before world.step)
        removeDeadBodies();
        world.step(dt, 6, 2);
    }
